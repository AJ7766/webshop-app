...
export function NavLink(props: Omit<ComponentProps<typeof Link>, "className">) {
    ...
    return <Link {...props} className={cn("p-4 hover:bg-secondary hover:text-secondary-foreground focus-visible:bg-secondary focus-visible:text-secondary-foregorund", pathName=== props.href && "bg-background text-foreground")} /> 
}